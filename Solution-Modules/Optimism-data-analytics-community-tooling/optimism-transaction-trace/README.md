#  Trace Optimism Transactions in Spare Parts NFT marketplace using Tenderly

Optimism transactions sometimes fail.
We are extending [Tenderly](https://tenderly.co/) to Trace Optimism Transactions in Spare Parts NFT marketplace to see what happened, what is the cause of the failure.
