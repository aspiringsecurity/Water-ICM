alter table sys_xs_sbss.bindings 
    add column sub_account_id varchar(256);
...
create type sys_xs_sbss.service_v2 as (instance_id varchar(256), binding_id varchar(256), service_id varchar(256), plan_id varchar(256), app_guid varchar(256), sub_account_id varchar(256)); 
